...
public class MinhaCasaMinhaDesgraca {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Endereco endereco1 = new Endereco("Rua ABC", 123, "", "Bela Vista", "Uruguaiana", UnidadeFederativa.RS);
        Casa casa1 = new Casa(endereco1, 70000, "Sim");
        opcoesParaFinanciamento.registrarImovel(casa1);

        Endereco endereco2 = new Endereco("Rua XYZ", 567, "Casa 3 (fundos)", "Bairro qualquer", "Rio de Janeiro", UnidadeFederativa.RJ);
        Casa casa2 = new Casa(endereco2, 80000, "Não");
        opcoesParaFinanciamento.registrarImovel(casa2);

        Endereco endereco3 = new Endereco("Rua Tal", 666, "Apartamento 101", "Outro bairro", "São Paulo", UnidadeFederativa.SP);
        Apartamento apartamento1 = new Apartamento (endereco3, 90000, 4);
